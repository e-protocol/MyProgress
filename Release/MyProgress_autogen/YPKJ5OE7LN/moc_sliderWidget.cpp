...
#include <memory>
#include "../../../MyProgress/src/ui/sliderWidget.h"
...
QT_MOC_LITERAL(1, 13, 12), // "indexChanged"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 8), // "newIndex"
QT_MOC_LITERAL(4, 36, 8) // "oldIndex"

    },
    "SliderWidget\0indexChanged\0\0newIndex\0"
    "oldIndex"
};
...
void SliderWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->indexChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SliderWidget::indexChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SliderWidget::indexChanged(int _t1, int _t2)
{
